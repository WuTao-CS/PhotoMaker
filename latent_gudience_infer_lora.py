...
from model.pipline import VAEProjectAnimateDiffPipeline,VAELoraProjectAnimateDiffPipeline
...
pipe = VAELoraProjectAnimateDiffPipeline.from_pretrained(
    base_model_path,
    motion_adapter=adapter,
    scheduler=scheduler,
).to("cuda")
pipe.load_lora_weights(args.unet_path,adapter_name="self_lora")
pipe.set_adapters("self_lora", 0.4)
pipe.set_fusion_model(unet_path=None, enable_update_motion=args.enable_update_motion, enable_origin_cross_attn=args.enable_origin_cross_attn)
print("over")
