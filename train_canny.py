...
from model.attention_processor import ReferVideoAttnProcessor2_0
...
def main(args):
    ...
    for name in unet.attn_processors.keys():
        ...
        if "motion_modules" in name:
            ...
            attn_procs[name] = ReferVideoAttnProcessor2_0(
    ...
    if args.with_vae:
        train_dataset = CelebVTextCannySD15Dataset(args.train_data_dir,new_prompt=args.enable_new_prompt,video_length=args.video_length, resolution=[args.resolution,args.resolution],frame_stride=args.frame_stride)
    else:
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                latents, ref_latents = torch.chunk(batch["video"],chunks=2,dim=2)
