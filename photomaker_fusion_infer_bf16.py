...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("-n", "--num_steps", type=int, default=500, help="number of steps")
...
for image_path,input_id_image in zip(image_path_list, input_id_images):
    ...
    # id_embeds = id_embeds.to(dtype=torch.bfloat16)
    # clip_embeds = clip_embeds.to(dtype=torch.bfloat16)
    ## Parameter setting
