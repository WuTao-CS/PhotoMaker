...
from model.attention_processor import LastFrameProjectAttnProcessor2_0, SkipMotionAttnProcessor2_0, LastFrameGatedAttnProcessor2_0, SkipLastMotionAttnProcessor2_0, NewLastFrameProjectAttnProcessor2_0, StoryDiffusionAttnProcessor2_0
from model.datasets.celebv_text import CelebVTextWhiteSD15Dataset,CelebVTextWhiteHeadSD15Dataset
...
def main(args):
    ...
    train_dataset = CelebVTextWhiteHeadSD15Dataset(args.train_data_dir, video_length=args.video_length, resolution=[args.resolution,args.resolution],frame_stride=args.frame_stride)
