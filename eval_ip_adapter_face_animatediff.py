...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--version", type=str, default="ip-adapter-faceid-portrait_sd15.bin")
...
pipe.load_ip_adapter("./pretrain_model/IP-Adapter-FaceID", subfolder=None, weight_name=args.version, image_encoder_folder=None)
...
for image_path,input_id_image in zip(image_path_list, input_id_images):
    ...
    all_dino_i=[]
    all_face_similarity=[]
    _, face_id_embeds = extract_face_features(app, [input_id_image])
