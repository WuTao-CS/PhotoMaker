...
from model.datasets.ffhq import FFHQVideoDataset
try:
    import torch_npu
...
def main(args):
    ...
    train_dataset = FFHQVideoDataset(root=args.train_data_dir, video_length=args.video_length, resolution=[args.resolution,args.resolution])
