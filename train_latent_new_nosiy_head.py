...
from model.datasets.celebv_text import CelebVTextWhiteSD15Dataset,CelebVTextNoisyHeadSD15Dataset
...
def main(args):
    ...
    train_dataset = CelebVTextNoisyHeadSD15Dataset(args.train_data_dir, video_length=args.video_length, resolution=[args.resolution,args.resolution],frame_stride=args.frame_stride,  new_prompt=args.enable_new_prompt)
