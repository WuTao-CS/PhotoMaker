...
#   --resolution 512 \
#   --output_dir "checkpoints/sd15_latent_new_lr_1e-5_4a100-motion-update-1030-with-ref-noisy-cross-attn-whitebg-frame_stride-stride-4-4card" \
#   --checkpoints_total_limit=50 \
#   --max_train_steps 200000 \
#   --train_batch_size=1 \
#   --gradient_accumulation_steps=1 \
...
#   --checkpointing_steps=10000 \
#   --resolution 512 \
#   --output_dir "checkpoints/sd15_latent_new_lr_1e-5_4a100-motion-no-update-1030-with-ref-noisy-cross-attn-whitebg-frame_stride-stride-8-4card" \
#   --checkpoints_total_limit=50 \
#   --max_train_steps 200000 \
#   --train_batch_size=1 \
#   --gradient_accumulation_steps=1 \
...
accelerate launch --config_file 'bash/accelerate_config_4a100_zero1.yaml' \
  ...
  --checkpointing_steps=10000 \
  --resolution 512 \
  --output_dir "checkpoints/sd15_latent_new_lr_1e-5_4a100-motion-update-1107-with-ref-noisy-cross-attn-whitebg-head-frame_stride-stride-8-4card" \
  --checkpoints_total_limit=50 \
  --max_train_steps 200000 \
  --train_batch_size=1 \
  --gradient_accumulation_steps=1 \
