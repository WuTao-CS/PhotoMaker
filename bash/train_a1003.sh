...
accelerate launch --config_file 'bash/accelerate_config_4a100_zero1.yaml' \
  ...
  --resolution 512 \
  --output_dir "checkpoints/sd15_latent_new_lr_1e-5_4a100-motion-update-1022-with-ref-noisy-cross-attn-only-face" \
...
#   --resolution 512 \
#   --output_dir "checkpoints/sd15_latent_new_lr_1e-5_4a100-with-motion-update-1016-cross-attn" \
#   --checkpoints_total_limit=50 \
#   --max_train_steps 200000 \
#   --train_batch_size=1 \
#   --gradient_accumulation_steps=1 \
