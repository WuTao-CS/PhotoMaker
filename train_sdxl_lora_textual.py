...
def main(args):
    ...
    init_token_embeds = torch.load('bust_shot_sdxl_emb.pt',map_location='cpu')
    setattr(unet, "inject_sdxl_learnable_token",torch.nn.Parameter(init_token_embeds, requires_grad=True))
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                prompt_embeds = torch.cat([prompt_embeds[:,:1,:], unet.inject_sdxl_learnable_token.repeat(bsz, 1, 1), prompt_embeds[:,1:,:]], dim=1)
                ...
                if accelerator.distributed_type == DistributedType.DEEPSPEED or accelerator.is_main_process:
                    if global_step % args.checkpointing_steps == 0:
                        ...
                        AnimateDiffSDXLPipeline.save_lora_weights(
                            ...
                            unet_param_to_learn=unet_lora_state_dict,
