...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--video", type=str, default='datasets/canny_single/ref_video.mp4',help="image")
...
for prompt in prompts:
    ...
    for seed in seed_list:
        ...
        export_to_gif(origin_frames,"{}/{}/{}_{}_seed_{}_origin.gif".format(args.output, dir_name, cnt, prompt.replace(' ','_'),seed))
        export_to_gif(canny_frames,"{}/{}/{}_{}_seed_{}_canny.gif".format(args.output, dir_name, cnt, prompt.replace(' ','_'),seed))