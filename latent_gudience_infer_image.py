...
from model.pipline import VAEImageDiffusionPipeline
...
pipe = VAEImageDiffusionPipeline.from_pretrained(
    base_model_path,
).to("cuda")
    ...
    for prompt in prompts:
        for seed in seed_list:
            ...
            frames = pipe(
                ...
                ref_image_embeds = input_id_image_emb,
            ...
            frames.save("{}/{}/{}_{}_seed_{}.png".format(args.output, dir_name, args.name, prompt.replace(' ','_'),seed))
