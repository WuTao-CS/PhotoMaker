...
from model.attention_processor import LastFrameProjectAttnProcessor2_0, SkipMotionAttnProcessor2_0, LastFrameGatedAttnProcessor2_0, NewLastFrameGatedAttnProcessor2_0
...
def main(args):
    ...
    for name in unet.attn_processors.keys():
        ...
        if "motion_modules" in name:
            ...
            attn_procs[name] = NewLastFrameGatedAttnProcessor2_0(
