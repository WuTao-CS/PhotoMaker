...
text_logger = open(os.path.join('data-process/poco/020_failed_valid_meta.txt'), 'a+')
...
def count_valid_meta(img_path):
    ...
    if 'caption_coco_singular' in meta_dict.keys():
        ...
        for future in concurrent.futures.as_completed(future_to_url):
            ...
            try:
                ...
                if valid_pos_count == 0:
                    with open("data-process/poco/020_no_trigger_word.txt", 'a+') as f:
                        f.write(f"{img_path}\n")
