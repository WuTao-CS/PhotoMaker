...
def parse_args(default=False):
    ...
    parser.add_argument(
        "--rank", type=int, default=32, help="Rank for lora weights."
    )
    parser.add_argument(
        "--center_crop",
        default=False,
    ...
    parser.add_argument(
        "--use_imdb",
        action="store_true",
        help="Whether or not to use IMDB dataset.",
    )
    parser.add_argument(
        "--use_ffhq_single",
        action="store_true",
    ...
    parser.add_argument(
        "--use_multi_embeds",
        action="store_true",
        help="Whether or not to use multiple embeddings.",
    )
    # ablation
    parser.add_argument(
        "--use_ablation",
        action="store_true",
        help="Whether or not to conduct ablation study",
    )
    parser.add_argument(
        "--use_ablation_idmix",
        action="store_true",
    ...
    parser.add_argument(
        '--prompt_weighting', 
        nargs='+', 
        help='a list of prompt weighting'
    )
    parser.add_argument(
        '--image_weighting',
        type=str,
        default=None, 
        help='image weighting parameter'
    )
    parser.add_argument(
        "--select_num",
        type=int,
    ...
    parser.add_argument(
        "--large_step_postfuse",
        action="store_true",
        help="Large scale learning rate.",
    )
    parser.add_argument(
        "--use_face_mask",
        action="store_true",
    ...
    parser.add_argument(
        "--use_concat_full_dataset",
        action="store_true",
        help="IMDB+Wallhaven.",
    )
    parser.add_argument(
        "--use_file_list_dataset",
        action="store_true",
        help="Whether or not to use multiple embeddings.",
    )
    parser.add_argument(
        "--use_concat_final_dataset",
        action="store_true",
        help="IMDB+Wallhaven+FFHQ",
    )
    parser.add_argument(
        "--use_concat_final_chinese_dataset",
        action="store_true",
        help="IMDB+Wallhaven+FFHQ+Chinese",
    )
    parser.add_argument(
        "--use_concat_imdbffhq_dataset",
        action="store_true",
        help="IMDB+FFHQ",
    )
    parser.add_argument(
        "--use_embed_loss",
        action="store_true",
        help="Whether or not to use embedding loss from clip.",
    )
    parser.add_argument(
        "--use_id_loss",
        action="store_true",
        help="Whether or not to use id loss.",
    )
    parser.add_argument(
        "--use_clip_loss",
        action="store_true",
        help="Whether or not to use clip loss.",
    )
    parser.add_argument(
        "--use_embed_clip_loss",
        action="store_true",
        help="Whether or not to use clip loss for embedding.",
    )
    parser.add_argument(
        "--use_finetune_embed_loss",
        action="store_true",
        help="Whether or not to use embed loss to finetune",
    )
    parser.add_argument(
        "--use_finetune_id_loss",
        action="store_true",
        help="Whether or not to use id loss to finetune",
    )
    parser.add_argument(
        "--use_object_transform",
        action="store_true",
        help="Whether or not to use object transform",
    )
    parser.add_argument(
        "--disable_enhance_prompt",
        action="store_true",
        help="Whether or not to disable the enhanced prompt",
    )
    parser.add_argument(
        "--embed_loss_weight",
        type=float,
    ...
    parser.add_argument(
        "--use_high_resolution",
        action="store_true",
        help="Whether or not to use high resolution dataset.",
    )
    parser.add_argument(
        "--learning_rate",
        type=float,
    ...
    parser.add_argument(
        "--use_max_num_objects",
        action="store_true",
        help="use maximum num object embeddings",
    )
    parser.add_argument(
        "--save_final_images",
        action="store_true",
    ...
    parser.add_argument(
        "--freeze_image_encoder_pretrained_path",
        type=str,
        default=None,
    )
    parser.add_argument(
        "--image_encoder_2_name_or_path",
        type=str,
        default=None,
    )
