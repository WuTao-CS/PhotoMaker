...
class CelebVTextWhiteHeadSD15Dataset(torch.utils.data.Dataset):
    def __init__(self, root: str, ref_root='./datasets/sh_CeleV-Text/segment_results_head', video_length = 16, resolution = [512,512], frame_stride=8, fixed_fps=None, with_scaling_factor=True, text_drop_ratio=0.05, image_drop_ratio=0.05, image_text_drop_ratio=0.05):
        self.root = root
        self.ref_root = ref_root
        self.video_length = video_length
        self.resolution = resolution
