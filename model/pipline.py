...
from model.attention_processor import LastFrameProjectAttnProcessor2_0, SkipMotionAttnProcessor2_0, LastFrameGatedAttnProcessor2_0, SkipLastFrameAttnProcessor2_0, NewLastFrameProjectAttnProcessor2_0
...
class VAEProjectAnimateDiffPipeline(AnimateDiffPipeline):
    def set_fusion_model(self,unet_path=None, enable_update_motion=False):
